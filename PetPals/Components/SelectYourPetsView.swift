        ...
        NavigationStack{
            ScrollView {
                LazyVGrid(columns: columns, spacing: 20){
                    SelectPetView(petName: "Tuffy", imageName: "p6")
                        .padding(.horizontal, 4)
                        .background(.gray)
                        .cornerRadius(8)
                    SelectPetView(petName: "Jerry", imageName: "p12")
                        .padding(.horizontal, 4)
                        .background(.gray)
                        .cornerRadius(8)
                    SelectPetView(petName: "Tuffy", imageName: "p11")
                        .padding(.horizontal, 4)
                        .background(.gray)
                        .cornerRadius(8)
                    SelectPetView(petName: "Jerry", imageName: "p10")
                        .padding(.horizontal, 4)
                        .background(.gray)
                        .cornerRadius(8)
